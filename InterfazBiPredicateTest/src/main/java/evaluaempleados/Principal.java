...
/**
 * Se requiere obtener un reporte con todos los empleados que cumplan con alguno
 * de estos dos conjuntos de criterios: 1) 25 años en adelante y que estén en el
 * departamento de Ventas o 2) 25 años en adelante y que estén en mostrador.
 */
@Slf4j
public class Principal {
	public static void main(String[] args) {
		...
		listaActualizada.forEach(empleado -> log.info("Nombre: {} - Edad: {} - Departamento: {}", empleado.getNombre(),
				empleado.getEdad(), empleado.getDepartamento()));
	}
}